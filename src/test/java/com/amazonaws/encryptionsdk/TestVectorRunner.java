...
public class TestVectorRunner {
    ...
    private static TestCase parseTest(String testName, Map<String, Object> data, Map<String, KeyEntry> keys,
        ...
        return new TestCase(testName, ciphertextURL, mks, matcher);
    }
    ...
    private static class TestCase {
        ...
        private TestCase(String name, String ciphertextPath, List<MasterKey<?>> mks, ResultMatcher matcher) {
            this(name, ciphertextPath, MultipleProviderFactory.buildMultiProvider(mks), matcher);
        }

        private TestCase(String name, String ciphertextPath, MasterKeyProvider<?> mkp, ResultMatcher matcher) {
            this.name = name;
